...
export function JobCard({ id, title, companyName, location, type, imageUrl, createdAt, className }: JobCardProps) {
  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        "glow-card transition-all duration-200 hover:-translate-y-0.5",
        className
      )}
    >
      {/* Top accent bar */}
